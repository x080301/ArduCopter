...
bool GCS_MAVLINK::try_send_message(enum ap_message id)//包的发送
{
...
void GCS_MAVLINK::handleMessage(mavlink_message_t* msg)//包的处理
{
    ...
    case MAVLINK_MSG_ID_COMMAND_LONG:       // MAV ID: 76    
    {
        ...
        case MAV_CMD_IIMOVE://每个命令有效期最多持续2s
            // param1 :升降速度（升+，降-）cm/s
            // param2 :
            // param3 :x轴（右+，左-）cm/s<-从上往下看
            // param4 :
            // param5 :y轴（上+，下-）cm/s<-从上往下看
            // param6 :
            // param7 :            
            HandleParameter(packet.param1, packet.param3, packet.param5);
            break;
        default:
            break;
        }*/
